...
We are using [nbgrader](https://github.com/jupyter/nbgrader) for this project, and adding functionality for partial credit in [this fork](https://github.com/kcranston/nbgrader).
